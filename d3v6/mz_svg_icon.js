...
const mz_svg_icon = () => {
	...
	const render = () => {
		...
		const icon = mz_svg_icon_data().par(p.icon);
		...
		ddiv
			...
			.style('left', div_width * p.subdiv_left + 'px')
			.style('top', div_height * p.subdiv_top + 'px')
			.style('width', div_width * p.subdiv_width + 'px')
			.style('height', div_height * p.subdiv_height + 'px')
			.style('display', 'flex')
			...
			.attr("width", div_width * p.subdiv_width)
			.attr("height", div_height * p.subdiv_height)
			.attr(
				"transform",
				`
